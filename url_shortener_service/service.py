...
class URLShortenerService:
    ...
    async def create_one(self, long_url: str):
        ...
        if await self.get_short_url(long_url): raise ValueError("URL already shortened")
        salt = 0 
    ...
    async def get_short_url(self, long_url: str):
        """Expands a short URL back to the original long URL."""
    ...
    async def _short_url_exist(self, short_url: str):
        ...
        return await self.database.get_one(short_url) is not None
